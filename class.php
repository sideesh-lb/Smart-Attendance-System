...
<input type="image" class="zoom noti"  src="noti.png"  >
...
interval=setInterval(function(){
 ...
 function notibox()
 { 
var model = '<div id="n" class="userdialog" title="Notifications">';
  model += '<div style="height:600px; border:3px solid blue ; overflow-y: scroll; margin-bottom:24px; padding:16px;"   class="ch"  id="notification">';
  model += '</div>';
  model += '<div class="formgroup" >';
  $('#noti').html(model);
 }
